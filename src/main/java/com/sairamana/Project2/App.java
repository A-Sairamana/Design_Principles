package com.sairamana.Project2;
...
public class App 
{
	...
	public static void main( String[] args )
    {
        ...
        System.out.println("lower limit is to be entered(available costs of candies here: 5,10,15)");
        lowlimit=in.nextInt();
        System.out.println("higher limit is to be entered(available costs of candies here: 5,10,15)");
